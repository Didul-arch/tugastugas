...
#let halaman-sampul(
  ...
  // Nama, nim, kelas: Times New Roman 14pt

  // susun secara vertikal dengan jarak 0,5 spasi antarbaris (PPKI Lampiran 1b: "Times New Roman 14, spasi satu, posisi center")
